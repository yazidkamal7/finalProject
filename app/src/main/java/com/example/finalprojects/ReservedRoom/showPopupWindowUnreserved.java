...
public class showPopupWindowUnreserved extends AppCompatActivity {
    ...
    public void showPopupWindow(final View v) {
        ...
        View popV = inflat.inflate(R.layout.popup_unreserved, null);
        ...
        text.setText("Are You SURE To UnBook This Room ?");

        Button editBTN = popV.findViewById(R.id.messageButtonYes);
